...
TestSuite(element_type_test_suite, .init=setup);

Test(element_type_test_suite, singleton) {
...
Test(element_type_test_suite, pointer_addition) {
...
Test(element_type_test_suite, addition) {
...
Test(element_type_test_suite, identity) {
    double x = 8.0, y;
...
Test(element_type_test_suite, set) {
    double x;
    double y = 7.0;
...
Test(element_type_test_suite, matches_string) {
    element_type* ptype = type_factory();
    char str1[] = "5.2";
    char str2[] = ".5";
