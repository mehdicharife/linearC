    ...
    element_type* uniform_type_distribution_get_cell_type(type_distribution* pthis, size_t row, size_t col);
    size_t uniform_type_distribution_total_size_before(type_distribution* pthis, size_t row_count, size_t col_count, spatial_order* porder, size_t row, size_t col);
